...
public class awsTest {
	...
	private static void init() throws Exception {
        String region = "us-east-2"; // 리전을 본인이 사용하는 리전으로 변경
		
        System.setProperty("aws.accessKeyId", "AKIARAUQWXEZZK5NQEUV");
        System.setProperty("aws.secretKey", "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");
        System.setProperty("aws.region", region); // 리전을 시스템 속성으로 설정
